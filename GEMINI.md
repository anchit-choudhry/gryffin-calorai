...
| **Tests**             | `apps/web/src/**/*.test.{ts,tsx}` (107 test files, 2025 tests)                                                                                                                                                                                                                                                                                                                                                                                                                               | Vitest + jsdom + fake-indexeddb + coverage                                                                                                                                                                      |
...
- [x] UX Uplift First Wave (WS A-F: typography, ornaments, quick-add, dashboard, streamlined logger,
  photo logging scaffold) - **Complete**
- [ ] UX Uplift Second Wave (WS G-J: retention, navigation, logging speed, system polish) - **In
  Progress**
- [ ] AI Photo Logging (Backend B5 milestone - vision LLM proxy) - **Planned**
- [ ] UX Uplift WS K-M - **Planned**
