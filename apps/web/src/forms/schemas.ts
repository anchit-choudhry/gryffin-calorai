...
// Feature 14: Micronutrient validation schema - all fields optional, non-negative with safe maxima
export const NutritionDataSchema = z.object({
  vitaminA: z.number().min(0, "Cannot be negative").max(15000).optional(),
  vitaminB12: z.number().min(0, "Cannot be negative").max(10000).optional(),
  vitaminB6: z.number().min(0, "Cannot be negative").max(200).optional(),
  vitaminC: z.number().min(0, "Cannot be negative").max(2000).optional(),
  vitaminD: z.number().min(0, "Cannot be negative").max(1000).optional(),
  vitaminE: z.number().min(0, "Cannot be negative").max(1000).optional(),
  vitaminK: z.number().min(0, "Cannot be negative").max(10000).optional(),
  folate: z.number().min(0, "Cannot be negative").max(10000).optional(),
  niacin: z.number().min(0, "Cannot be negative").max(1000).optional(),
  thiamine: z.number().min(0, "Cannot be negative").max(1000).optional(),
  calcium: z.number().min(0, "Cannot be negative").max(5000).optional(),
  iron: z.number().min(0, "Cannot be negative").max(500).optional(),
  magnesium: z.number().min(0, "Cannot be negative").max(5000).optional(),
  potassium: z.number().min(0, "Cannot be negative").max(15000).optional(),
  sodium: z.number().min(0, "Cannot be negative").max(50000).optional(),
  zinc: z.number().min(0, "Cannot be negative").max(500).optional(),
  copper: z.number().min(0, "Cannot be negative").max(100).optional(),
  iodine: z.number().min(0, "Cannot be negative").max(10000).optional(),
  phosphorus: z.number().min(0, "Cannot be negative").max(10000).optional(),
  selenium: z.number().min(0, "Cannot be negative").max(10000).optional(),
  fiber: z.number().min(0, "Cannot be negative").max(200).optional(),
  sugar: z.number().min(0, "Cannot be negative").max(500).optional(),
  saturatedFat: z.number().min(0, "Cannot be negative").max(200).optional(),
  transFat: z.number().min(0, "Cannot be negative").max(100).optional(),
  cholesterol: z.number().min(0, "Cannot be negative").max(5000).optional(),
});

export type NutritionDataFormValues = z.infer<typeof NutritionDataSchema>;
