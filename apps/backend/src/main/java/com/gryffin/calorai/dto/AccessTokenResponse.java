...
/**
 * Access token response returned after authentication or cookie-based refresh.
 * The refresh token is no longer in the response body; it is set as an HttpOnly cookie
 * by the server to prevent XSS theft (SEC-002).
 */
