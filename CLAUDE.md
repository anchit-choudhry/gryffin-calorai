...
**Context:** v0.8.0 in progress (June 2026), full-stack: React frontend + Spring Boot backend (
auth +
PostgreSQL).
Health-focused personal tool. Database schema v19. Target: v1.0.0 with cloud sync and native mobile
apps (v0.8-v1.0).
...
- **Store:** Zustand store composed from 8 slices (`foodSlice`, `recipeSlice`, `bodySlice`,
  `activitySlice`, `trackerSlice`, `settingsSlice`, `coreSlice`, `syncSlice`) unified in
  `AppState.ts`.
...
For release history & changes, see @@release-notes/0.8.0.md (in progress),
...
**Last Updated:** June 6, 2026 | **Current release:** v0.8.0 in progress | **In
progress:** B5 AI Photo Logging; backend security hardened (OWASP + Google Java Style); 90 test
files, 1796 tests
